...
package com.gs.app.netsuiteerp.ui.pages.home.adapter;
...
import com.gs.app.netsuiteerp.utils.DensityUtil;
...
public class ModuleListAdapter extends RecyclerView.Adapter<ModuleListAdapter.ViewHolderBean> implements View.OnClickListener {
    ...
    public ModuleListAdapter(@NonNull Context context, @NonNull List<String> objects) {
        ...
        itemViewHeight = (DensityUtil.INSTANCE.getScreenW(context)
                - 2 * context.getResources().getDimensionPixelSize(R.dimen.preference_padding_l_r)
                - 2 * context.getResources().getDimensionPixelSize(R.dimen.preference_divider_l_r)) / 3;
    }

    @NonNull
    @Override
    public ViewHolderBean onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolderBean(layoutInflater.inflate(R.layout.item_module, parent, false));
    }
