 ...
 * 带清除按钮的输入框
 */
public class GsMaterialEditText extends TextInputEditText implements
    ...
    private boolean autoShowClearIcon=false;

    private int maxInputLength=-1;

    public GsMaterialEditText(Context context) {
    	this(context, null);
    }

    public GsMaterialEditText(Context context, AttributeSet attrs) {
    	//这里构造方法也很重要，不加这个很多属性不能再XML里面定义
    	this(context, attrs, android.R.attr.editTextStyle);
    }

    public GsMaterialEditText(Context context, AttributeSet attrs, int defStyle) {
